...
const { menuList } = menuRef; // делаем деструктуризацию по основным переменным, чтобы получить к ним доступ
// console.log(menuList);

import menu from '../menu.json'; //подключаем файл с анными массива
// console.log(menu);
